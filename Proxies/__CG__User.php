...
class User extends \User implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'User' . "\0" . 'id', '' . "\0" . 'User' . "\0" . 'username', '' . "\0" . 'User' . "\0" . 'password', '' . "\0" . 'User' . "\0" . 'firstname', '' . "\0" . 'User' . "\0" . 'lastname', '' . "\0" . 'User' . "\0" . 'email', '' . "\0" . 'User' . "\0" . 'token', '' . "\0" . 'User' . "\0" . 'news'];
        }
